...
class Url {
  static String baseUrl = "https://kabadiathome.com/kabadi";
  static String loginUrl = "$baseUrl/api/send-otp";
  static String otpUrl = "$baseUrl/api/verify-otp";
  ...
  static String getPickupListUrl = "$baseUrl/api/get-all-pickup-list";
  static String pickupCancelRequest = "$baseUrl/api/pickup-cancel-request";
  static String pickupReschedule = "$baseUrl/api/pickup-reschedule";
