...
class SellScrapView extends StatelessWidget {
                ...
                SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Icon(Icons.keyboard_arrow_down,size: 16,color: whiteColor,)
                                              ],
                                            ),
                                          ),
                                        ],
                      ...
                      controller.tabController.value == 0?Padding(
                              ...
                              children: [
                                RichText(
                                    text: TextSpan(children: [
                                      ...
                                      const TextSpan(text: " "),
                                      TextSpan(
                                        text: controller.getLocationList,
                                        style: TextStyle(
                                            fontSize: 20,
                                            fontFamily: "Poppins",
                                            color: darkGreenColor,
                                ...
                                Text("Select the items you would like to sell ?",
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontFamily: "Poppins",
                                        color: textSubColor,
                          ...
                          child: Column(
                              ...
                              children: [
                                RichText(
                                    ...
                                    textAlign: TextAlign.left),
                                const SizedBox(height: 5),
                                Text("Prices may fluctuate based on Industry rates.",
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontFamily: "Poppins",
                                        color: textSubColor,
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    border: Border.all(
                      color: sellController.isSelected(sellController.getCategoryList[index].categoryId!)
                          ? primaryColor
                          : lightGreenColor,
                      width: 2,
                    ),
                ...
                Column(
                  children: [
                    Align(
                      ...
                      child: Text(
                        sellController.getCategoryList[index].categoryName ?? "null",
                        style: TextStyle(
                          fontSize: 14,
                          fontFamily: "Poppins",
                          color: darkGreenColor,
                    ...
                    Align(
                      ...
                      child: SizedBox(
                        width: 80,
                        child: Text(
                          sellController.getCategoryList[index].priceListName ?? "null",
            ...
            itemBuilder: (context, index) {
              return Column(
                ...
                children: [
                  ...
                  Text(sellController.getAllPriceList[index].name ?? "null",
                      style: TextStyle(
                          fontSize: 16,
                          fontFamily: "Poppins",
                          color: textSubColor,
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount: sellController.getAllPriceList[index].subCategories?.length,
                      itemBuilder: (context, index) {
                        GetPriceSubCategories subList = sellController.getAllPriceList[index].subCategories![index];
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("${subList.priceUnit}/-${subList.weightUnit}",
                                  style: TextStyle(
                                      fontSize: 14,
                                      fontFamily: "Poppins",
                                      color: textSubColor,
                          ...
                          children: [
                            InkWell(onTap:() {
                              ...
                              child: Container(
                                ...
                                padding: const EdgeInsets.all(10),
                                decoration: BoxDecoration(
                                    color: controller.isCheck.value== true?primaryColor:whiteColor,
                                    shape: BoxShape.circle,
                                    border: Border.all(
                          ...
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                ...
                                padding: const EdgeInsets.all(10),
                                decoration: BoxDecoration(
                                    color: controller.isCheck.value== false?primaryColor:whiteColor,
                                    shape: BoxShape.circle,
                                    border: Border.all(
                                        width: 1, color: borderColor)),
                                child: SvgPicture.asset(
              ...
              child: Column(
                ...
                children: [
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text(
                      AppConstants.selectPickupLocation,
                      style: TextStyle(
                          fontSize: 20,
                          fontFamily: "Poppins",
                          color: darkGreenColor,
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text(
                      AppConstants.yourSavedAddresses,
                      style: TextStyle(
                          fontSize: 14,
                          fontFamily: "Poppins",
                          color: textSubColor,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Obx(() => GestureDetector(
                        onTap: () {
                          ...
                          print("index : $index : ${sellController.myIndex}");
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              border: sellController.myIndex.value == index
                                  ...
                                  : null,
                              color: sellController.myIndex.value != index ? lightBg : whiteColor,
                          ...
                          child: Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    sellController.myAddressData[index].locationType ?? "null",
                                    style: TextStyle(
                                        fontSize: 14,
                                        fontFamily: "Poppins",
                                        color: darkGreenColor,
                                  ...
                                  const SizedBox(height: 10),
                                  Text(
                                    sellController.myAddressData[index].addressLine ?? "null",
                                    style: TextStyle(
                                        fontSize: 10,
                                        fontFamily: "Poppins",
                                        color: darkGreenColor,
  ...
  onTapContinue() {
    ...
    Get.toNamed(Routes.sellScrapItemView, arguments: continueController.selectedIds);
  }
}
