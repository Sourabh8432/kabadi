...
class ProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProfileController>(
        ...
        builder: (controller) {
          print("ImageUrl : ${controller.profileList?.image.toString()}");
          return Scaffold(
              ...
              body: Stack(
                children: [
                  Column(crossAxisAlignment:
                                ...
                                children: [
                                  GestureDetector(onTap: (){
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        Text("profile".tr, style: TextStyle(
                                            fontSize: 18,
                                            fontFamily: "Poppins",
                                            color: whiteColor,
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      ...
                                      Get.toNamed(Routes.editProfileView, arguments: [
                                        {
                                          'name':
                                          controller.profileList?.name.toString()
                                        },
                                        {
                                          'user_id':controller.profileList?.userId.toString()
                                        },
                                        {
                                          'image':controller.profileList?.image.toString()
                                        },
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        Text("editProfile".tr, style: TextStyle(
                                            fontSize: 12,
                                            fontFamily: "Poppins",
                                            color: whiteColor,
                          ...
                          child: ClipOval(
                            child: Image.network(
                              ...
                              errorBuilder: (context, error, stackTrace) {
                                return Image.asset(AppImages.profile,fit: BoxFit.fill,);
                              },
                            ),
                          ),
                        ),
                    ...
                    Text(controller.profileList?.name ?? " ", style: TextStyle(
                        fontSize: 18,
                        fontFamily: "Poppins",
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Text("pickupAddress".tr, style: TextStyle(
                              fontSize: 12,
                              fontFamily: "Poppins",
                              color: textSubColor,
                              fontWeight: FontWeight.w600)),
